...
if [ $rsp == 0 ]; then
  git remote set-url --push origin git clone git clone ssh://esjkadm100@gerrit.ericsson.se:29418/OSS/ENIQ-Parent/OSS/com.ericsson.eniq/network-analytics-IMS-capacity-Analysis
