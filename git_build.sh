...
function setRstate {
	...
	#mv IMS-capacity-Analysis/build/feature-release.xml IMS-capacity-Analysis/build/feature-release.${rstate}.xml
	mv IMS-capacity/build/feature-release.xml IMS-capacity/build/feature-release.${rstate}.xml
